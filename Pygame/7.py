...
while running:
    ...
    # Егер жылан ортасына жетсе, ойынды тоқтату
    head_x, head_y = snake.body[0]
    if (head_x >= WIDTH // 2 - CELL_SIZE and head_x <= WIDTH // 2 + CELL_SIZE) and \
       (head_y >= HEIGHT // 2 - CELL_SIZE and head_y <= HEIGHT // 2 + CELL_SIZE):
        snake.alive = False
